...
function buildEmailHtml(profile: VoiceProfile): string {
      ...
      return `
        <tr>
          <td style="padding: 16px 0;">
            <div style="display: flex; justify-content: space-between; font-size: 14px; font-weight: 600; color: #6B6860; margin-bottom: 8px;">
              <span style="float: left;">${labels.low}</span>
              <span style="float: right;">${labels.high}</span>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%;">
          ...
          <tr>
            <td style="padding: 0 0 32px 0;">
              <span style="font-size: 24px; font-weight: 400; color: #1A1A18; font-family: Georgia, serif;">accent</span>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 0 0 8px 0;">
              <p style="font-size: 13px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.08em; color: #A8A49C; margin: 0;">Your Voice Profile</p>
            </td>
          </tr>
          <tr>
            <td style="padding: 0 0 32px 0;">
              <h1 style="font-size: 36px; font-weight: 800; color: #1A1A18; line-height: 1.15; margin: 0;">${profile.top_traits.join(". ")}.</h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 0 0 16px 0;">
              <h2 style="font-size: 24px; font-weight: 800; color: #1A1A18; margin: 0;">Writing tips for your voice</h2>
            </td>
          </tr>
          <tr>
            <td>
          ...
          <tr>
            <td style="padding: 32px 0;" align="center">
              <a href="https://myaccent.io/dashboard" style="display: inline-block; background: #4A6CF7; color: #ffffff; text-decoration: none; border-radius: 12px; padding: 16px 48px; font-size: 18px; font-weight: 700;">Start logging</a>
            </td>
          </tr>
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { error } = await resend.emails.send({
      ...
      html: buildEmailHtml(voiceProfile),
    });
