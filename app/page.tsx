        ...
        <div className="max-w-[640px] mx-auto px-6 py-10 md:py-14">
          <div className="pl-6" style={{ borderLeft: `2px solid ${BLUE}` }}>
            <p className="font-serif italic" style={{ fontSize: "clamp(19px, 2.8vw, 24px)", fontWeight: 300, lineHeight: 1.55, color: INK }}>
              "I have plenty of material scattered everywhere. I just never know which piece matters most, for which channel, or when to post it. So I end up posting nothing."
            </p>
            <p className="font-sans mt-3.5" style={{ fontSize: 13, color: DIM }}>— Heather, founder</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[660px] mx-auto px-6 py-12 md:py-20">
          ...
          <div>
            {[
              ...
              { n: "02", title: "Develop", desc: "Select one note or a few. Accent asks what happened, connects it to what it knows about you, and helps you find the story only you could tell.", icon: "M6 6h0.01 M12 6h0.01 M18 6h0.01 M6 12h0.01 M18 12h0.01 M12 18h0.01 M6 6L12 12 M18 6L12 12 M12 12L12 18" },
              ...
              { n: "04", title: "Drafts", desc: "Your work in progress. Everything you've started lives here. Pick up where you left off, post when you're ready.", icon: "M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2z M9 7h6 M9 11h6 M9 15h4" },
            ].map((s, i, arr) => (
