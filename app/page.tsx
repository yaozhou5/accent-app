    ...
    <div style={{ background: "#fff", color: INK }}>
      ...
      >
        <div className="max-w-[960px] mx-auto px-5 md:px-12 h-full flex items-center justify-between">
          <span
            ...
            style={{ fontSize: 20, fontWeight: 600, color: scrolled ? INK : "#fff" }}
          >
            accent
          </span>
          <Link
      ...
      <section id="demo" style={{ background: "#FAFAFA" }}>
        <div ref={s2.ref} style={s2.style} className="max-w-[900px] mx-auto px-6 py-12 md:py-20">
          <div className="text-center mb-10">
            <span className="font-mono uppercase" style={{ fontSize: 11, letterSpacing: "0.14em", color: BLUE }}>
              How it works
            </span>
            <h2 className="font-serif mt-3" style={{ fontSize: "clamp(24px, 3.6vw, 36px)", fontWeight: 400 }}>
      ...
      <section ref={s3.ref} style={s3.style}>
        <div className="max-w-[660px] mx-auto px-6 py-12 md:py-20">
          <h2
            className="font-serif text-center mb-8 md:mb-14"
            style={{ fontSize: "clamp(24px, 3.6vw, 34px)", fontWeight: 400 }}
          >
            Four stations. One flow.
          </h2>
          <div>
            {[
              {
                n: "01",
                title: "Log",
                desc: "Quick notes, voice memos, random thoughts. Whatever comes to mind. 2-3 minutes throughout your week.",
                icon: "M4 4h16v16H4z M8 8h8 M8 12h5",
              },
              {
                n: "02",
                title: "Develop",
                desc: "Select one note or a few. Accent asks what happened, connects it to what it knows about you, and helps you find the story only you could tell.",
                icon: "M6 6h0.01 M12 6h0.01 M18 6h0.01 M6 12h0.01 M18 12h0.01 M12 18h0.01 M6 6L12 12 M18 6L12 12 M12 12L12 18",
              },
              {
                n: "03",
                title: "Write",
                desc: "Pick a story and write it. Accent helps you as you go — better words, tighter structure, the angle that makes people stop scrolling.",
                icon: "M4 20L8 16L18 6L20 8L10 18L6 20z M14 10L16 8",
              },
              {
                n: "04",
                title: "Drafts",
                desc: "Your work in progress. Everything you've started lives here. Pick up where you left off, post when you're ready.",
                icon: "M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2z M9 7h6 M9 11h6 M9 15h4",
              },
            ].map((s, i, arr) => (
              <div
                key={s.n}
              ...
              >
                <div>
                  ...
                  <span className="font-mono block" style={{ fontSize: 12, color: BLUE, fontWeight: 500 }}>
                    {s.n}
                  </span>
                </div>
                <div>
                  <h3 className="font-serif mb-1.5" style={{ fontSize: 22, fontWeight: 400 }}>
                    {s.title}
                  </h3>
                  <p className="font-sans" style={{ fontSize: 14, color: DIM, lineHeight: 1.65 }}>
                    {s.desc}
                  </p>
                </div>
              </div>
      ...
      <section ref={s4.ref} style={s4.style}>
        <div className="max-w-[840px] mx-auto px-6 py-12 md:py-20">
          <h2
            className="font-serif text-center mb-8 md:mb-12"
            style={{ fontSize: "clamp(24px, 3.6vw, 32px)", fontWeight: 400, color: INK }}
          >
            ...
            {[
              {
                ...
                desc: "You don't need AI telling you what to post. You need help seeing the content that's already hiding in your week.",
              },
              {
              ...
              {
                title: "It starts with you, not AI.",
                desc: "Log what happened first. Then ideas come from your stories — not from a prompt. Real input, real output.",
              },
              {
              ...
              >
                <h3 className="font-sans mb-2" style={{ fontSize: 17, fontWeight: 600, color: INK }}>
                  {b.title}
                </h3>
                <p className="font-sans" style={{ fontSize: 15, color: DIM, lineHeight: 1.7 }}>
                  {b.desc}
                </p>
              </div>
            ))}
      ...
      <section style={{ background: "#FAFAFA" }}>
        <div className="max-w-[640px] mx-auto px-6 py-12 md:py-20">
          ...
          <p className="font-sans text-center mb-8 md:mb-12" style={{ fontSize: 15, color: DIM }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div style={{ background: "#fff", borderRadius: 12, padding: 28, border: `1px solid ${BORDER}` }}>
              <span
                ...
                style={{ fontSize: 11, letterSpacing: "0.08em", color: DIM }}
              >
                Free
              </span>
            ...
            <div style={{ background: "#fff", borderRadius: 12, padding: 28, border: `1.5px solid ${BLUE}` }}>
              <span
                className="font-mono uppercase block mb-4"
                style={{ fontSize: 11, letterSpacing: "0.08em", color: BLUE }}
              >
                Pro — $19/mo
              </span>
              <ul className="space-y-2.5" style={{ listStyle: "none", padding: 0, margin: 0 }}>
      ...
      <section
        ref={s5.ref}
        style={{ ...s5.style, background: "#FAFAFA", backgroundImage: dotGridBg, backgroundSize: "24px 24px" }}
      >
        <div className="max-w-[840px] mx-auto px-6 py-12 md:py-20">
          <h2
            className="font-serif text-center mb-8 md:mb-12"
            style={{ fontSize: "clamp(24px, 3.6vw, 34px)", fontWeight: 400, lineHeight: 1.3 }}
          >
            Built for founders who'd rather build
            <br className="hidden md:inline" /> <em>than plan content</em>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3" style={{ gap: 14 }}>
            {[
              ...
              <div
                key={c.title}
                style={{ padding: "24px 22px", border: `1px solid ${BORDER}`, borderRadius: 12, background: "#fff" }}
              >
                <div
                  className="mb-3 flex items-center justify-center"
                  style={{ width: 56, height: 56, borderRadius: "50%", background: `${c.bg}14` }}
                >
                  <span style={{ fontSize: 28 }}>{c.emoji}</span>
                </div>
                <h3 className="font-serif mb-3" style={{ fontSize: 17, fontWeight: 400 }}>
                  {c.title}
                </h3>
                <p className="font-sans text-[13px] mb-3" style={{ color: DIM, lineHeight: 1.55 }}>
                  {c.pain}
                </p>
                <div style={{ borderTop: `1px solid ${BORDER}`, paddingTop: 12 }}>
                  <p className="font-sans text-[13px]" style={{ color: INK, lineHeight: 1.55 }}>
                    {c.how}
                  </p>
                </div>
              </div>
      ...
      <footer style={{ borderTop: `1px solid ${BORDER}` }}>
        <div className="max-w-[840px] mx-auto px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <span className="font-serif" style={{ fontSize: 16, fontWeight: 600, color: INK }}>
            accent
          </span>
