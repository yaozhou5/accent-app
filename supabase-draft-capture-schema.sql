...
-- creation, never overwritten by edits) and already feeds the existing
-- voice_signals pipeline (lib/supabase/drafts.ts). This migration only adds
-- the two missing snapshot columns; RLS already covers `drafts` as a whole.
